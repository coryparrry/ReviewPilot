...
- To render screenshot-style inline review cards for Codex from a completed review run, use `python ".\plugins\codex-review\scripts\emit_inline_review_comments.py" --review-dir "<review-run-dir>"`
